    ...
    <div className="mt-2 space-y-1">
      ...
      <p className="text-xs" style={{ color: colors[score] }}>
        ...
        {score < MIN_SCORE && password.length > 0 && (
          <span style={{ color: 'rgba(61,26,10,0.4)' }}> — troppo debole per procedere</span>
        )}
      </p>
    </div>
  )
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="rounded-2xl p-8 max-w-sm w-full text-center"
        ...
        <button onClick={onClose}
          ...
          style={{ backgroundColor: '#8b3a1e', color: '#f2e8d9', fontFamily: "'Georgia', serif" }}>
          Ho capito
        </button>
      </div>
      ...
      <div className="flex min-h-screen" style={{ fontFamily: "'Georgia', serif" }}>
        ...
        <div className="hidden lg:flex w-1/2 bg-[#8b3a1e] flex-col justify-between px-14 py-14 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-[#f5d9c8] text-4xl font-bold leading-tight">Campo Sportivo<br />Panoramica</h1>
          </div>
          ...
          <div className={`my-8 transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            {locked ? (
              <div className="lock-pulse max-w-xs rounded-xl border border-[#8b3a1e]/30 bg-[#8b3a1e]/10 p-6 text-center space-y-3">
                ...
                <p className="text-[#8b3a1e] font-semibold text-sm uppercase tracking-wide">Registrazione temporaneamente bloccata</p>
                <p className="text-[#3d1a0a]/50 text-xs leading-relaxed">Troppi tentativi falliti.<br />Riprova tra:</p>
                <div className="text-4xl font-bold text-[#8b3a1e] tracking-wider">{formatTimeLeft(timeLeft)}</div>
              ...
              <>
                ...
                <h2 className="text-[#3d1a0a] text-3xl font-bold leading-tight mb-3">Crea il tuo<br />account</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 max-w-xs" noValidate>
                  ...
                  <button type="submit" disabled={loading}
                    ...
                    style={{
                      backgroundColor: '#8b3a1e', color: '#f2e8d9',
...
function inputStyle({ error, valid }) {
  return {
    border: error ? '1.5px solid rgba(139,58,30,0.6)' : valid ? '1.5px solid rgba(139,58,30,0.35)' : '1.5px solid rgba(139,58,30,0.15)',
  ...
  return (
    <div>
      <label className="block text-[11px] font-semibold tracking-[1.5px] uppercase mb-1.5"
        style={{ color: 'rgba(61,26,10,0.4)' }}>{label}</label>
      {children}
      {error && (
