    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .db-root { min-height: 100vh; background: #f5f0e8; font-family: 'DM Sans', sans-serif; color: #0f172a; }
        .db-header { background: #fff; border-bottom: 2px solid #e8e2d8; position: sticky; top: 0; z-index: 100; box-shadow: 0 1px 12px rgba(0,0,0,0.06); }
        ...
        .db-brand-logo { width: 40px; height: 40px; background: linear-gradient(135deg, #254d38, #1a3a2a); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 20px; box-shadow: 0 4px 12px rgba(26,58,42,0.3); }
        .db-brand-name { font-family: 'Bebas Neue', sans-serif; font-size: 24px; color: #0f172a; letter-spacing: 3px; }
        .db-brand-name span { color: #1a3a2a; }
        ...
        .db-hero { background: linear-gradient(120deg, #1a3a2a 0%, #254d38 50%, #2d6247 100%); padding: 40px 0 44px; position: relative; overflow: hidden; }
        ...
        .db-hero-eyebrow { font-size: 12px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: rgba(245,240,232,0.7); margin-bottom: 8px; }
        .db-hero-title { font-family: 'Bebas Neue', sans-serif; font-size: clamp(36px, 5vw, 58px); color: #f5f0e8; letter-spacing: 3px; line-height: 1; margin-bottom: 10px; }
        .db-hero-sub { font-size: 15px; color: rgba(245,240,232,0.75); font-weight: 300; }
        .db-main { max-width: 1200px; margin: 0 auto; padding: 36px 24px 60px; }
        .profilo-card { background: #fff; border: 1.5px solid #ddd8ce; border-radius: 18px; padding: 28px 32px; margin-bottom: 40px; box-shadow: 0 2px 16px rgba(0,0,0,0.04); position: relative; overflow: hidden; }
        .profilo-card::before { content: ''; position: absolute; left: 0; top: 0; bottom: 0; width: 4px; background: linear-gradient(180deg, #254d38, #1a3a2a); border-radius: 4px 0 0 4px; }
        .profilo-card-header { display: flex; align-items: center; gap: 16px; margin-bottom: 24px; }
        .profilo-avatar { width: 50px; height: 50px; background: linear-gradient(135deg, #254d38, #1a3a2a); border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 22px; box-shadow: 0 4px 12px rgba(26,58,42,0.25); flex-shrink: 0; }
        ...
        .campi-section-title span { color: #1a3a2a; }
        .campi-count { background: #d1e8dc; color: #1a3a2a; font-size: 12px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; padding: 5px 12px; border-radius: 20px; }
        .struttura-block { margin-bottom: 44px; }
        .struttura-header { display: flex; align-items: center; gap: 10px; margin-bottom: 18px; padding-bottom: 14px; border-bottom: 2px solid #e8e2d8; }
        .struttura-icon { width: 32px; height: 32px; background: #d1e8dc; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 16px; }
        .struttura-name { font-family: 'Bebas Neue', sans-serif; font-size: 20px; color: #1a3a2a; letter-spacing: 2px; }
        ...
        .campo-card { background: #fff; border: 1.5px solid #ddd8ce; border-radius: 18px; padding: 24px; transition: all 0.25s; position: relative; overflow: hidden; }
        .campo-card:hover { border-color: #254d38; transform: translateY(-4px); box-shadow: 0 16px 48px rgba(26,58,42,0.12); }
        .campo-card-accent { position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, #254d38, #2d6247); transform: scaleX(0); transition: transform 0.3s ease; transform-origin: left; border-radius: 18px 18px 0 0; }
        .campo-card:hover .campo-card-accent { transform: scaleX(1); }
        .campo-sport-badge { display: inline-flex; align-items: center; gap: 5px; background: #e8f2ec; border: 1px solid #b8d4c4; color: #1a3a2a; font-size: 10px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; padding: 4px 10px; border-radius: 20px; margin-bottom: 14px; }
        ...
        .campo-footer { display: flex; align-items: flex-end; justify-content: space-between; margin-bottom: 16px; padding-top: 16px; border-top: 1px solid #e8e2d8; }
        ...
        .campo-prezzo-badge { background: #e8f2ec; color: #1a3a2a; font-size: 11px; font-weight: 700; padding: 4px 8px; border-radius: 8px; letter-spacing: 0.5px; }
        .btn-prenota { width: 100%; background: linear-gradient(135deg, #254d38, #1a3a2a); color: #f5f0e8; border: none; border-radius: 12px; padding: 14px; font-family: 'Bebas Neue', sans-serif; font-size: 18px; letter-spacing: 3px; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 14px rgba(26,58,42,0.25); }
        .btn-prenota:hover { background: linear-gradient(135deg, #1a3a2a, #0d1f15); transform: translateY(-1px); box-shadow: 0 8px 24px rgba(26,58,42,0.35); }
        ...
        .orario-selezionato { background: linear-gradient(135deg, #254d38, #1a3a2a); border-color: #1a3a2a; color: #f5f0e8; box-shadow: 0 4px 12px rgba(26,58,42,0.3); }
        ...
        .btn-conferma { flex: 2; background: linear-gradient(135deg, #254d38, #1a3a2a); border: none; color: #f5f0e8; padding: 14px; border-radius: 12px; font-family: 'Bebas Neue', sans-serif; font-size: 20px; letter-spacing: 3px; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 14px rgba(26,58,42,0.3); }
        .btn-conferma:hover:not(:disabled) { background: linear-gradient(135deg, #1a3a2a, #0d1f15); transform: translateY(-1px); box-shadow: 0 8px 24px rgba(26,58,42,0.4); }
        .btn-conferma:disabled { opacity: 0.45; cursor: not-allowed; transform: none; }
        .successo-box { text-align: center; padding: 24px 0; }
        .successo-icon { width: 80px; height: 80px; background: linear-gradient(135deg, #254d38, #1a3a2a); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 36px; margin: 0 auto 20px; box-shadow: 0 8px 32px rgba(26,58,42,0.35); animation: popIn 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); }
                    ...
                    <>
                      ...
                      <div className="legenda">
                        <div className="legenda-item">
                          <div className="legenda-dot" style={{ background: '#254d38', borderColor: '#1a3a2a' }} />
                          Selezionato
                        </div>
                        <div className="legenda-item">
